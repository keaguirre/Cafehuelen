...
*/
    urlApiLogin: 'http://127.0.0.1:8000/api/superv_local/',
    urlApiIngredientes: 'http://127.0.0.1:8000/api/ingrediente/',
    urlApiPreparaciones: 'http://127.0.0.1:8000/api/preparacion/',
